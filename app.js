...
app.post('/comprar', async (req, res) => {
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            line_items: items,
            mode: 'payment',
            success_url: 'http://localhost:3000/pago-exitoso.html' || '/pago-exitoso.html', // URL de éxito
            cancel_url: 'http://localhost:3000/carrito.html' || '/carrito.html' // URL de cancelación
        });
